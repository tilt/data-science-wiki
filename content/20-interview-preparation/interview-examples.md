...
| API design for LLM tools | Separate model-proposed tool calls from application validation and execution. | [Tool Use and Function Calling](../10-generative-ai/tool-use-and-function-calling.md) |
