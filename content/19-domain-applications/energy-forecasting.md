...
Weather forecast error propagates directly into load forecasts. Demand response, new tariffs, electrification, rooftop solar, and economic changes create [concept drift](../14-ml-engineering-and-mlops/concept-drift.md). Production [forecast monitoring](../05-time-series-and-forecasting/forecast-monitoring.md) should track missing telemetry, calibration by quantile, ramp errors, and peak-period residuals.
