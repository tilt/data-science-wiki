...
Perception evaluation uses [object detection](../09-computer-vision/object-detection.md), tracking, and [detection and segmentation metrics](../09-computer-vision/detection-and-segmentation-metrics.md), but aggregate mAP is not enough. A safety review should combine [offline evaluation](../17-experimentation-and-evaluation/offline-evaluation.md), curated [golden datasets](../17-experimentation-and-evaluation/golden-datasets.md), simulation, replay, and on-road review. Use [risk-weighted error taxonomies](../17-experimentation-and-evaluation/risk-weighted-error-taxonomies.md) for vulnerable road users, occlusions, night, rain, construction, emergency vehicles, and unusual signs. Probabilities should be checked with [calibration](../03-classical-machine-learning/calibration.md) before downstream planning consumes them.
