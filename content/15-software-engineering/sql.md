...
related:
  ...
  - "api-design.md"
  - "testing.md"
  - "../12-data-engineering/sql.md"
  - "../12-data-engineering/relational-modelling.md"
historical_context: false
last_reviewed: 2026-07-11
---
# SQL

SQL in software engineering is an application contract: which records a user may see, which transaction boundary protects a change, and which query shape stays stable under load. The deeper SQL-language and warehouse-pattern discussion belongs in [data engineering SQL](../12-data-engineering/sql.md); this page focuses on using SQL safely from services.
