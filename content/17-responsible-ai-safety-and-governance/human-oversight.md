...
The page for [human-in-the-loop systems](../13-ml-engineering-and-mlops/human-in-the-loop-systems.md) covers operational design; here the governance focus is whether the review changes outcomes and leaves evidence in [auditability](auditability.md).
