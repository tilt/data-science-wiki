...
> **Learning path — Foundations:** ← [Probability and Statistics](../02-probability-and-statistics/index.md) · [path overview](../00-home-and-navigation/learning-paths.md#foundations) · [Supervised Learning](supervised-learning.md) →
