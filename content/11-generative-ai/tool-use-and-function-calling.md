...
> **Learning path — Generative AI systems:** ← [RAG](rag.md) · [path overview](../00-home-and-navigation/learning-paths.md#generative-ai-systems) · [RAG Evaluation](rag-evaluation.md) →
