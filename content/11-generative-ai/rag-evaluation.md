...
> **Section — [Generative AI and Agentic Systems](index.md):** ← [Hallucination Mitigation](hallucination-mitigation.md) · [RAG Architecture Comparison](rag-architecture-comparison.md) →

> **Learning path — [Generative AI systems](../00-home-and-navigation/learning-paths.md#generative-ai-systems):** ← [Tool Use and Function Calling](tool-use-and-function-calling.md) · [Responsible AI, Safety, and Governance](../18-responsible-ai-safety-and-governance/index.md) →
