...
> **Section — [ML Engineering and MLOps](index.md):** [Training Pipelines](training-pipelines.md) →

> **Learning path — [Production ML](../00-home-and-navigation/learning-paths.md#production-ml):** [Training Pipelines](training-pipelines.md) →
