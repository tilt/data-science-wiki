...
> **Section — [Information Retrieval and Search](index.md):** ← [TF-IDF](tf-idf.md) · [Inverted Indexes](inverted-indexes.md) →

> **Learning path — [Information retrieval and search](../00-home-and-navigation/learning-paths.md#information-retrieval-and-search):** ← [Inverted Indexes](inverted-indexes.md) · [Dense Retrieval](dense-retrieval.md) →
