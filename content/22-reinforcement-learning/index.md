...
related:
  ...
  - "../18-domain-applications/autonomous-driving.md"
...
- [LLM Training](../10-generative-ai/llm-training.md) uses self-supervised pretraining, instruction tuning, and sometimes preference-based RL.
- [Autonomous Driving](../18-domain-applications/autonomous-driving.md) uses RL selectively for planning, control, simulation, and policy optimization, but production stacks also rely heavily on perception, prediction, and safety engineering.
