...
- [Autonomous Driving](../18-domain-applications/autonomous-driving.md) uses simulation, planning, prediction, and sometimes learned policies under strict safety constraints.
...
- [LLM Training](../10-generative-ai/llm-training.md) shares the sequence-model idea during pretraining but uses different objectives and evaluation.
