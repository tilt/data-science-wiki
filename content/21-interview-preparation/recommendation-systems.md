...
| "How do you evaluate ranking?" | Recall@k, [NDCG](../12-information-retrieval-and-search/precision-recall-map-mrr-ndcg.md), coverage, diversity, novelty, time splits, online experiments, and guardrails. | [Evaluation of Recommenders](../04-recommendation-systems/evaluation-of-recommenders.md) |
