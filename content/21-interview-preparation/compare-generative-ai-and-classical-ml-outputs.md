...
related:
  - "../17-experimentation-and-evaluation/comparing-generative-ai-and-classical-ml-systems.md"
  - "../17-experimentation-and-evaluation/golden-datasets.md"
  - "../17-experimentation-and-evaluation/paired-evaluation.md"
...
2. Use the same examples where possible through [golden datasets](../17-experimentation-and-evaluation/golden-datasets.md) or [paired evaluation](../17-experimentation-and-evaluation/paired-evaluation.md).
...
Use [Evaluation](evaluation.md) for the interview evaluation map, [Generative AI](generative-ai.md) for the system-design map, and [RAG Evaluation](../11-generative-ai/rag-evaluation.md) for grounded answer checks.
