...
1. [V-JEPA 2](../10-video-understanding/v-jepa-2.md) extends the [V-JEPA](../10-video-understanding/v-jepa.md) idea: predict masked or future representations rather than reconstructing every pixel.
2. A [vision-language model](../11-generative-ai/vision-language-models.md) is trained or aligned for language-conditioned behavior.
...
Read [V-JEPA 2 versus Vision-Language Models](../10-video-understanding/v-jepa-2-versus-vision-language-models.md), [World Models and JEPA](../10-video-understanding/world-models-and-jepa.md), and the interview map [World Models](world-models.md).
