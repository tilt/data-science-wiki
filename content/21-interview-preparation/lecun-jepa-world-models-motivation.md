...
1. [World models](../10-video-understanding/world-models.md) aim to represent state, dynamics, uncertainty, and consequences of actions.
2. [JEPA](../10-video-understanding/world-models-and-jepa.md) predicts missing or future latent representations, not raw pixels or tokens.
...
Read [World Models and JEPA](../10-video-understanding/world-models-and-jepa.md), [World Models](world-models.md), and [V-JEPA 2 versus Vision-Language Models](v-jepa-2-versus-vision-language-model.md). Historical context lives in [World Models and JEPA Background](../20-history-of-ai-and-machine-learning/world-models-and-jepa-background.md).
