...
>
> [← Content-Based Recommendation](content-based-recommendation.md) [User-Based Collaborative Filtering →](user-based-collaborative-filtering.md)
>
> **Learning path** — [Recommender systems](../00-home-and-navigation/learning-paths.md#recommender-systems)
>
> [← Recommendation Systems and Personalization](index.md) [Matrix Factorization for Recommender Systems →](matrix-factorization.md)
