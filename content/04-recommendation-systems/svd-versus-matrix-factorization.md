...
> **Learning path — Recommender systems:** ← [Matrix Factorization](matrix-factorization.md) · [path overview](../00-home-and-navigation/learning-paths.md#recommender-systems)
