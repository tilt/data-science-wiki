...
| 2018 | Devlin, Chang, Lee, and Toutanova introduced BERT with masked language modeling. | Bidirectional [pretraining](../10-generative-ai/pretraining.md) turned unlabeled text into task-transferable contextual representations. |
...
| 2021 | He, Chen, Xie, Li, Dollar, and Girshick introduced masked autoencoders for scalable vision learning. | Masked reconstruction made [self-supervised visual learning](../08-computer-vision/self-supervised-visual-learning.md) align naturally with ViT-style patch representations. |
