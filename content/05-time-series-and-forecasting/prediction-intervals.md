...
Suppose a daily demand model produces a point forecast of 1,000 units and a 90 percent interval of 850 to 1,220.

1. Record the forecast origin and horizon.
2. After demand is observed, check whether actual demand lies between 850 and 1,220.
3. Repeat across many comparable forecasts.
4. Compute empirical coverage and average width by horizon.
