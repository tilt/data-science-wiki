...
- [Autonomous Driving](../18-domain-applications/autonomous-driving.md) often decomposes the full driving problem into perception, prediction, planning, and control rather than treating the whole stack as one unconstrained MDP.
