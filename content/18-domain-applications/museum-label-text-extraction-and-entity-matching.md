...
prerequisites:
  - index.md
related:
  - ../08-computer-vision/ocr-pipelines.md
  - ../07-natural-language-processing/entity-linking-and-matching.md
  - ../07-natural-language-processing/information-extraction.md
  - ../07-natural-language-processing/semantic-textual-similarity.md
  - ../13-ml-engineering-and-mlops/human-in-the-loop-systems.md
  - ../08-computer-vision/historical-document-and-museum-label-analysis.md
...
The visual front end is an [OCR pipeline](../08-computer-vision/ocr-pipelines.md): detect the label, rectify perspective, run OCR, and preserve layout. The language layer uses [information extraction](../07-natural-language-processing/information-extraction.md) for fields, then [entity linking and matching](../07-natural-language-processing/entity-linking-and-matching.md) against collection records, Getty ULAN, Wikidata, or local authority files. [Semantic textual similarity](../07-natural-language-processing/semantic-textual-similarity.md) helps rank candidates, but thresholds must consider field type. "Monet, 1907" means different things in an artist line, title line, or provenance note.
...
Naive whole-line similarity picks the title-like entity, not the artist. The artifact shows why field extraction must precede entity matching, and why uncertain links should flow to [human-in-the-loop systems](../13-ml-engineering-and-mlops/human-in-the-loop-systems.md).

## Failure Modes

Common failures include OCR substitutions in names, multilingual labels, historical spelling variants, artist collectives, ambiguous dates, and labels that omit the accession number. Pages in [historical document and museum label analysis](../08-computer-vision/historical-document-and-museum-label-analysis.md) should be evaluated by field-level F1 and link accuracy separately.
