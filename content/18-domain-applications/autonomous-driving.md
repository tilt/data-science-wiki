...
| Perception | Objects, lanes, free space, traffic lights, signs, occupancy, and semantic scene state. | [Object detection](../08-computer-vision/object-detection.md), [semantic segmentation](../08-computer-vision/semantic-segmentation.md), 3D detection, BEV transformers, occupancy networks. |
...
| Evaluation and safety | Scenario pass/fail, collision risk, rule compliance, interventions, and residual risk. | [Risk-weighted error taxonomies](../16-experimentation-and-evaluation/risk-weighted-error-taxonomies.md), simulation, replay, closed-loop testing, safety cases. |
