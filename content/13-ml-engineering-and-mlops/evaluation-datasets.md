...
The gate should match failure cost. A fraud system may block release on a low-recall slice even when global AUC improves. The experimentation section covers [offline evaluation](../16-experimentation-and-evaluation/offline-evaluation.md) more generally.
