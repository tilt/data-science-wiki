...
> **Learning path — Computer vision:** ← [Object Detection](object-detection.md) · [path overview](../00-home-and-navigation/learning-paths.md#computer-vision) · [Vision Transformers](vision-transformers.md) →
